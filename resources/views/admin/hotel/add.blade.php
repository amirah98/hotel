        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="card">
                        <div class="header">
                            <h4 class="title">Add Hotel</h4>
                        </div>
                        <div class="content">
                            {!! Form::open(array('url' => 'admin/hotel/', 'id' => 'hotel-add-form')) !!}
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control border-input"
                                               placeholder="Ex: Hotel Yak and Yeti" value="{{ old('name') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" class="form-control border-input"
                                               placeholder="Ex: 9842100000" value="{{ old('phone') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="alt_phone" class="form-control border-input"
                                               placeholder="Ex: 9842100000" value="{{ old('alt_phone') }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="email" class="form-control border-input"
                                               placeholder="Ex: joe@example.com" value="{{ old('email') }}">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" rows="5" class="form-control border-input"
                                                  placeholder="Ex: Kamalpokhari, kathmandu.">{{ old('address') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="text-center">
                                <button type="submit" class="btn btn-info btn-fill btn-wd">Add Hotel</button>
                            </div>
