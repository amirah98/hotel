            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="card card-wizard" id="wizardCard">
                        {!! Form::open(array('id' => 'wizardForm', 'url' => 'admin/destination/'.$destination->id.'/route')) !!}
                        {{ Form::hidden('_method', 'POST') }}
                        {{ csrf_field() }}
                        <div class="header text-center">
                            <h4 class="title">Route Add Wizard</h4>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="tab2">
                                    ...
                                    <div class="row">
                                        <div class="col-md-10 col-md-offset-1">
                                            <div class="header">
                                                <h4 class="title">Travel Option 1</h4>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label class="control-label">
                                                    ...
                                                    <select class="form-control" name="travel_medium[0][name]">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control"
                                                           type="text"
                                                           name="travel_medium[0][travel_time]"
                                                           placeholder="Ex: 5"
                                                           value=""/>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control"
                                                           type="text"
                                                           name="travel_medium[0][travel_cost]"
                                                           placeholder="Ex: 5000"
                                                    />
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-10 col-md-offset-1">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="travel_medium[0][difficulty]">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea rows="3" class="form-control"
                                                              name="travel_medium[0][description]"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
